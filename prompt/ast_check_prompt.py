...
IMPORTANT: In your previous attempt, you have inadvertently altered parts of the code outside the designated markers (e.g., modifying loop guards, adding extra variables, or changing control flow), leading to different program code. To avoid such issues, I will provide the previously incorrectly generated code and the AST comparison information for this task, which illustrates the differences between the original and previous code (i.e., the parts that were tampered with). Please carefully analyze these materials to ensure that your correction strictly adheres to the original program code and only inserts the necessary ranking function verification code at the specified markers.    
...
"""
    ...
    user_prompt = (
        ...
        f"{c_code}\n"
        "previously incorrectly generated code:\n"
        f"{llm_c_code}\n"
        "AST comparison information:\n"
        f"{ast_error_information}\n"
